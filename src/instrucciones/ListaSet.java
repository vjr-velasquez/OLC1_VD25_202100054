...
public class ListaSet extends Instruccion {

    private String id;
    private Instruccion indice;
    private Instruccion valor;

    public ListaSet(String id, Instruccion indice, Instruccion valor, int linea, int col) {
    ...
    public Object interpretar(Arbol arbol, tablaSimbolos tabla) {
        ...
        if (base == tipoDato.VOID) {
            // si estaba sin tipo, lo definimos por el primer set()
        ...
        if (valor.tipo.getTipo() != base) {
            return new Errores(
                    "SEMANTICO",
                    "Tipos erroneos en set() de '" + id + "': se esperaba " + base + " y viene " + valor.tipo.getTipo(),
                    this.linea, this.col
            );
        }
